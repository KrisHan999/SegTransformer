...
class SegTransformer_V1(nn.Module):
    ...
    def forward(self, x):
        ...
        input_token_embedding = self.token_embedding.weight.unsqueeze(1).repeat(1, B, 1) + self.avg_pool_embedding(enc_out_5).squeeze().unsqueeze(0).repeat(self.n_class, 1, 1)
        ...
        transformer_out = [transformer_out_1 + enc_out_1,
                           transformer_out_2 + enc_out_2,
                           transformer_out_3 + enc_out_3,
                           transformer_out_4 + enc_out_4,
                           transformer_out_5 + enc_out_5
                           ]
